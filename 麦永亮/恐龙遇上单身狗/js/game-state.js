		...
		init: function() {
			...
			game.States.play = function() {
				...
				this.rndSize = function() {
					...
					this.factor == 1 ? this.dog.scale.setTo(0.3, 0.3) : this.dog.scale.setTo(0.6, 0.6);
					this.factor == 1 ? this.dinosaur.scale.setTo(0.6, 0.6) : this.dinosaur.scale.setTo(0.3, 0.3);
				}
				...
				this.gameEnd = function() {
					...
					game.time.events.add(Phaser.Timer.SECOND * 2, function(){game.state.start('end');}, this);
