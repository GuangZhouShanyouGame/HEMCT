        ...
        init: function() {
            ...
            game.States.play = function() {
                this.create = function() {
                    ...
                    {
                        game.world.setBounds(0, 0, game.world.width, game.world.height * 2);
                        bg.height = game.world.height;
                        game.add.tween(game.camera).to({ y: game.camera.y + game.world.height / 2 }, 2000, Phaser.Easing.Linear.None, true, 1000);
                    }, this);
                    //开启定时器
